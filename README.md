...
Passionate about **Frontend Development**, **Artificial Intelligence**, **UI/UX Design**, and **Code Optimization**.  
Interested in building efficient, user-centered, and scalable digital solutions.
...
![Typst](https://img.shields.io/badge/Typst-239DAD?style=flat)
...
- **[dnswatcher](https://niclabs.cl/)** *(Go)* — NIC Chile Labs  
- **[Games developed](https://valgguk.itch.io/)** — **Godot Engine**  
- **Web Applications** — React, Next.js, Django  
- **Data Analysis & Systems Programming** — C++  
...
- Reading fiction and exploring emerging technologies  
- Video games  
...
> My productivity increases significantly on cloudy days
